        ...
        while True:
            try:
                if self.proxies:
                    ...
                    r = requests.post(LOGIN_API, headers=headers, data={"loginName": self.username, "loginPwd": self.password})
        ...
        while True:
            try:
                if PROXY:
                    ...
                    r = requests.post("https://game.nimingxx.com/api/role/sign", headers=headers, cookies={"sign": self.userinfo.sign, "niming_email": self.username})
                ...
                if PROXY:
                    ...
                    r = requests.post("https://game.nimingxx.com/api/role/receiveWhReward", headers=headers, cookies={"sign": self.userinfo.sign, "niming_email": self.username})
                DynLog.record_log(self.userinfo.name + json.loads(r.text)['msg'])
                return
            except requests.exceptions.SSLError as e:
        ...
        while True:
            try:
                if PROXY:
                    ...
                    r = requests.post("https://game.nimingxx.com/api/role/getActivity", headers=headers, cookies={"sign": self.userinfo.sign, "niming_email": self.username})
